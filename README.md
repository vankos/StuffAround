...
| **All Attractions** | Combined results from Google, OSM, TripAdvisor, and Wikidata | Required (Google + TripAdvisor) |
...
1. Enter coordinates in the `lat,lng` field or tap **Current coordinates**.
2. Choose a data source and tap the corresponding **Generate GPX** button.
